            ...
            ! function(t, i) {
                ...
                function u(t, i, r, h) {
                    for (var e = 0, o = 0, s = Math.min(t.length, r), u = i; u < s; u++) {
                        ...
                        e *= h, o = a >= 49 ? a - 49 + 10 : a >= 17 ? a - 17 + 10 : a, n(a >= 0 && o < h, "Invalid character"), e += o
                    }
                    return e
                }
                ...
                if (e.isBN = function(t) {
                        ...
                        var h = 0;
                        "-" === (t = t.toString().replace(/\s+/g, ""))[0] && (h++, this.negative = 1), h < t.length && (16 === i ? this._parseHex(t, h, r) : (this._parseBase(t, i, h), "le" === r && this._initArray(this.toArray(), i, r)))
                        ...
                        for (var h, e, o = 0; o < this.length; o++) this.words[o] = 0;
                        var s = 0;
                        if ("be" === r)
                            for (o = t.length - 1, h = 0; o >= 0; o -= 3) e = t[o] | t[o - 1] << 8 | t[o - 2] << 16, this.words[h] |= e << s & 67108863, this.words[h + 1] = e >>> 26 - s & 67108863, (s += 24) >= 26 && (s -= 26, h++);
                        else if ("le" === r)
                            for (o = 0, h = 0; o < t.length; o += 3) e = t[o] | t[o + 1] << 8 | t[o + 2] << 16, this.words[h] |= e << s & 67108863, this.words[h + 1] = e >>> 26 - s & 67108863, (s += 24) >= 26 && (s -= 26, h++);
                        return this._strip()
                    }, e.prototype._parseHex = function(t, i, r) {
                        this.length = Math.ceil((t.length - i) / 6), this.words = Array(this.length);
                        for (var n, h = 0; h < this.length; h++) this.words[h] = 0;
                        var e = 0,
                            o = 0;
                        if ("be" === r)
                            for (h = t.length - 1; h >= i; h -= 2) n = s(t, i, h) << e, this.words[o] |= 67108863 & n, e >= 18 ? (e -= 18, o += 1, this.words[o] |= n >>> 26) : e += 8;
                        else
                            for (h = (t.length - i) % 2 == 0 ? i + 1 : i; h < t.length; h += 2) n = s(t, i, h) << e, this.words[o] |= 67108863 & n, e >= 18 ? (e -= 18, o += 1, this.words[o] |= n >>> 26) : e += 8;
                        this._strip()
                ...
                e.prototype.toString = function(t, i) {
                    if (i = 0 | i || 1, 16 === (t = t || 10) || "hex" === t) {
                        ...
                        for (var r, h = 0, e = 0, o = 0; o < this.length; o++) {
                            ...
                            e = s >>> 24 - h & 16777215, (h += 2) >= 26 && (h -= 26, o--), r = 0 !== e || o !== this.length - 1 ? f[6 - u.length] + u + r : u + r
                        }
                    ...
                    var h = this.byteLength(),
                        e = r || Math.max(1, h);
                    n(h <= e, "byte array longer than desired length"), n(e > 0, "Requested array length <= 0");
                    ...
                    for (var i, r, n = 0; n < r.length; n++) this.words[n] = i.words[n] ^ r.words[n];
                    if (this !== i)
                    ...
                    var r = t / 26 | 0,
                        h = t % 26;
                    return this._expand(r + 1), i ? this.words[r] = this.words[r] | 1 << h : this.words[r] = this.words[r] & ~(1 << h), this._strip()
                    ...
                    for (var i, r, n, h = 0, e = 0; e < n.length; e++) i = (0 | r.words[e]) + (0 | n.words[e]) + h, this.words[e] = 67108863 & i, h = i >>> 26;
                    ...
                    h > 0 ? (i = this, r = t) : (i = t, r = this);
                    for (var e = 0, o = 0; o < r.length; o++) e = (n = (0 | i.words[o]) - (0 | r.words[o]) + e) >> 26, this.words[o] = 67108863 & n;
                    for (; 0 !== e && o < i.length; o++) e = (n = (0 | i.words[o]) + e) >> 26, this.words[o] = 67108863 & n;
                    ...
                    for (var n = 0, h = 0, e = 0; e < r.length - 1; e++) {
                        ...
                        for (var s = 67108863 & n, u = Math.min(e, i.length - 1), a = Math.max(0, e - t.length + 1); a <= u; a++) {
                            var l = e - a,
                                ...
                                f = 67108863 & m;
                            o = o + (m / 67108864 | 0) | 0, s = 67108863 & (f = f + s | 0), h += (o = o + (f >>> 26) | 0) >>> 26, o &= 67108863
                        }
                        r.words[e] = s, n = o, o = h
                    }
                ...
                Math.imul || (v = M), e.prototype.mulTo = function(t, i) {
                    ...
                    return 10 === this.length && 10 === t.length ? v(this, t, i) : n < 63 ? M(this, t, i) : c(this, t, i)
                }, g.prototype.makeRBT = function(t) {
                    for (var i = Array(t), r = e.prototype._countBits(t) - 1, n = 0; n < t; n++) i[n] = this.revBin(n, r, t);
                    return i
                        ...
                        for (var s = o << 1, u = Math.cos(2 * Math.PI / s), a = Math.sin(2 * Math.PI / s), l = 0; l < h; l += s)
                            for (var m = u, f = a, d = 0; d < o; d++) {
                                var p = r[l + d],
                                    ...
                                    c = n[l + d + o],
                                    g = m * v - f * c;
                                c = m * c + f * v, v = g, r[l + d] = p + v, n[l + d] = M + c, r[l + d + o] = p - v, n[l + d + o] = M - c, d !== s && (g = u * m - a * f, f = u * f + a * m, m = g)
                            }
                    ...
                    return t
                }, g.prototype.convert13b = function(t, i, r, h) {
                    ...
                    var i = new e(null);
                    return i.words = Array(this.length + t.length), c(this, t, i)
                    ...
                    for (var r = 0, h = 0; h < this.length; h++) {
                        ...
                        r >>= 26, r += (e / 67108864 | 0) + (o >>> 26), this.words[h] = 67108863 & o
                    }
                    return 0 !== r && (this.words[h] = r, this.length++), i ? this.ineg() : this
                    ...
                    if (++n < i.length)
                        for (var h = r.sqr(); n < i.length; n++, h = h.sqr()) 0 !== i[n] && (r = r.mul(h));
                    return r
                    ...
                    n("number" == typeof t && t >= 0), h = i ? (i - i % 26) / 26 : 0;
                    var h, e = t % 26,
                        o = Math.min((t - e) / 26, this.length),
                        s = 67108863 ^ 67108863 >>> e << e;
                    if (h -= o, h = Math.max(0, h), r) {
                    ...
                    var i = t % 26,
                        r = (t - i) / 26;
                    return (n(0 === this.negative, "imaskn works only with positive numbers"), this.length <= r) ? this : (0 !== i && r++, this.length = Math.min(r, this.length), 0 !== i && (this.words[this.length - 1] &= 67108863 ^ 67108863 >>> i << i), this._strip())
                    ...
                    for (h = 0; h < t.length; h++) {
                        ...
                        var u = (0 | t.words[h]) * i;
                        e -= 67108863 & u, s = (e >> 26) - (u / 67108864 | 0), this.words[h + r] = 67108863 & e
                    }
                    for (; h < this.length - r; h++) s = (e = (0 | this.words[h + r]) + s) >> 26, this.words[h + r] = 67108863 & e;
                    if (0 === s) return this._strip();
                    for (n(-1 === s), s = 0, h = 0; h < this.length; h++) s = (e = -(0 | this.words[h]) + s) >> 26, this.words[h] = 67108863 & e;
                    ...
                    0 != (n = 26 - this._countBits(s)) && (o = o.ushln(n), h.iushln(n), s = 0 | o.words[o.length - 1]);
                    ...
                    0 === l.negative && (h = l, r && (r.words[u] = 1));
                    for (var m = u - 1; m >= 0; m--) {
                        var f = (0 | h.words[o.length + m]) * 67108864 + (0 | h.words[o.length + m - 1]);
                        for (f = Math.min(f / s | 0, 67108863), h._ishlnsubmul(o, f, m); 0 !== h.negative;) f--, h.negative = 0, h._ishlnsubmul(o, 1, m), h.isZero() || (h.negative ^= 1);
                        r && (r.words[m] = f)
                    }
                    return r && r._strip(), h._strip(), "div" !== i && 0 !== n && h.iushrn(n), {
                        div: r || null,
                        mod: h
                    }
                    ...
                    return (n(!t.isZero()), this.isZero()) ? {
                        div: new e(0),
                        mod: new e(0)
                    } : 0 !== this.negative && 0 === t.negative ? (s = this.neg().divmod(t, i), "mod" !== i && (h = s.div.neg()), "div" !== i && (o = s.mod.neg(), r && 0 !== o.negative && o.iadd(t)), {
                        div: h,
                        mod: o
                    }) : 0 === this.negative && 0 !== t.negative ? (s = this.divmod(t.neg(), i), "mod" !== i && (h = s.div.neg()), {
                        div: h,
                        mod: s.mod
                    ...
                    var i = t < 0;
                    i && (t = -t), n(t <= 67108863);
                    for (var r = 67108864 % t, h = 0, e = this.length - 1; e >= 0; e--) h = (r * h + (0 | this.words[e])) % t;
                    return i ? -h : h
                    ...
                    for (var h = new e(1), o = new e(0), s = new e(0), u = new e(1), a = 0; i.isEven() && r.isEven();) i.iushrn(1), r.iushrn(1), ++a;
                    for (var l = r.clone(), m = i.clone(); !i.isZero();) {
                        for (var f = 0, d = 1;
                            (i.words[0] & d) == 0 && f < 26; ++f, d <<= 1);
                        if (f > 0)
                            for (i.iushrn(f); f-- > 0;)(h.isOdd() || o.isOdd()) && (h.iadd(l), o.isub(m)), h.iushrn(1), o.iushrn(1);
                        for (var p = 0, M = 1;
                            (r.words[0] & M) == 0 && p < 26; ++p, M <<= 1);
                        if (p > 0)
                            for (r.iushrn(p); p-- > 0;)(s.isOdd() || u.isOdd()) && (s.iadd(l), u.isub(m)), s.iushrn(1), u.iushrn(1);
                        i.cmp(r) >= 0 ? (i.isub(r), h.isub(s), o.isub(u)) : (r.isub(i), s.isub(h), u.isub(o))
                    }
                    return {
                        a: s,
                        b: u,
                    ...
                    for (var o = new e(1), s = new e(0), u = h.clone(); r.cmpn(1) > 0 && h.cmpn(1) > 0;) {
                        ...
                        for (var m = 0, f = 1;
                            (h.words[0] & f) == 0 && m < 26; ++m, f <<= 1);
                        if (m > 0)
                            for (h.iushrn(m); m-- > 0;) s.isOdd() && s.iadd(u), s.iushrn(1);
                        r.cmp(h) >= 0 ? (r.isub(h), o.isub(s)) : (h.isub(r), s.isub(o))
                    }
                ...
                y.prototype._tmp = function() {
                ...
                }, h(b, y), b.prototype.split = function(t, i) {
                    ...
                    var h = t.words[9];
                    for (n = 10, i.words[i.length++] = 4194303 & h; n < t.length; n++) {
                        var e = 0 | t.words[n];
                ...
                }, h(_, y), h(k, y), h(A, y), A.prototype.imulK = function(t) {
                    for (var i = 0, r = 0; r < t.length; r++) {
                    ...
                    for (var h = this.m.subn(1), o = 0; !h.isZero() && 0 === h.andln(1);) o++, h.iushrn(1);
                    n(!h.isZero());
                    ...
                    for (var m = this.pow(l, h), f = this.pow(t, h.addn(1).iushrn(1)), d = this.pow(t, h), p = o; 0 !== d.cmp(s);) {
                        ...
                        n(v < p);
                        var c = this.pow(m, new e(1).iushln(p - v - 1));
                        f = f.redMul(c), m = c.redSqr(), d = d.redMul(m), p = v
                    }
                    return f
                    ...
                    for (0 === u && (u = 26), n = i.length - 1; n >= 0; n--) {
                        for (var a = i.words[n], l = u - 1; l >= 0; l--) {
                            var m = a >> l & 1;
                            if (h !== r[0] && (h = this.sqr(h)), 0 === m && 0 === o) {
                                s = 0;
                                continue
                            }
                            o <<= 1, o |= m, (4 == ++s || 0 === n && 0 === l) && (h = this.mul(h, r[o]), s = 0, o = 0)
                        }
                        u = 26
                    }
                    return h
                    ...
                    return new x(t)
                }, h(x, S), x.prototype.convertTo = function(t) {
                    ...
                    var r = t.imul(i),
                        ...
                        e = h;
                    return h.cmp(this.m) >= 0 ? e = h.isub(this.m) : 0 > h.cmpn(0) && (e = h.iadd(this.m)), e._forceRed(this)
                    ...
                    var r = t.mul(i),
                        ...
                        h = r.isub(n).iushrn(this.shift),
                        o = h;
                    return h.cmp(this.m) >= 0 ? o = h.isub(this.m) : 0 > h.cmpn(0) && (o = h.iadd(this.m)), o._forceRed(this)
