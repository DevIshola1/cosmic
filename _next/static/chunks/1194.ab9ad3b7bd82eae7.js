        ...
        48764: function(t, e, r) {
            ...
            function T(t, e, r, n, i, o) {
                if (t > r || t < e) {
                    ...
                    throw n = o > 3 ? 0 === e || e === BigInt(0) ? `>= 0${i} and < 2${i} ** ${(o+1)*8}${i}` : `>= -(2${i} ** ${(o+1)*8-1}${i}) and < 2 ** ${(o+1)*8-1}${i}` : `>= ${e}${i} and <= ${r}${i}`, new _.ERR_OUT_OF_RANGE("value", n, t)
                }
            ...
            O("ERR_BUFFER_OUT_OF_BOUNDS", function(t) {
                ...
                let n = `The value of "${t}" is out of range.`,
                    i = r;
                return Number.isInteger(r) && Math.abs(r) > 4294967296 ? i = R(String(r)) : "bigint" == typeof r && (i = String(r), (r > BigInt(2) ** BigInt(32) || r < -(BigInt(2) ** BigInt(32))) && (i = R(i)), i += "n"), n += ` It must be ${e}. Received ${i}`
            }, RangeError);
            let S = /[^+/0-9A-Za-z-_]/g;
        ...
        17187: function(t) {
            ...
            t.exports = o, t.exports.once = function(t, e) {
                return new Promise(function(r, n) {
                    ...
                    g(t, e, f, {
                        ...
                        once: !0
                    }, "function" == typeof t.on && g(t, "error", o, i))
                })
            ...
            Object.defineProperty(o, "defaultMaxListeners", {
                ...
                if ("function" == typeof u) n(u, this, e);
                    ...
                    for (var h = u.length, l = y(u, h), r = 0; r < h; ++r) n(l[r], this, e);
                return !0
        ...
        80645: function(t, e) { /*! ieee754. BSD-3-Clause License. Feross Aboukhadijeh <https://feross.org/opensource> */
            e.read = function(t, e, r, n, i) {
                ...
                var f, s, u, h = 8 * o - i - 1,
                    ...
                    y = n ? 1 : -1,
                    g = e < 0 || 0 === e && 1 / e < 0 ? 1 : 0;
                for (isNaN(e = Math.abs(e)) || e === 1 / 0 ? (s = isNaN(e) ? 1 : 0, f = l) : (f = Math.floor(Math.log(e) / Math.LN2), e * (u = Math.pow(2, -f)) < 1 && (f--, u *= 2), f + a >= 1 ? e += p / u : e += p * Math.pow(2, 1 - a), e * u >= 2 && (f++, u /= 2), f + a >= l ? (s = 0, f = l) : f + a >= 1 ? (s = (e * u - 1) * Math.pow(2, i), f += a) : (s = e * Math.pow(2, a - 1) * Math.pow(2, i), f = 0)); i >= 8; t[r + c] = 255 & s, c += y, s /= 256, i -= 8);
